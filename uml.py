class Movie:
    ...
    def _init_(self, title:str, genre:str, year:int):
        """
        Intitalize the Moview object with a title, genre, and year.
        Arguments:
...
class MovieManager:
    ...
    def _init_(self):
        """
        Initilalizes with an empty list of movies.
        """
        self.movies = []
    ...
    def delete_movie(self, index: int) -> None:
        ...
        Arguments:
        index: The index of the Moview to be removied.
        """
